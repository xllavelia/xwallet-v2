...
const roadHome = () => {
  ...
  const cardsData = [
    {
      assets: [
        { name: 'Bitcoin', ticker: 'BTC', amount: 0.00024, fiat: 8.00, icon: '' },
        { name: 'Ethereum', ticker: 'ETH', amount: 0.0005, fiat: 4.50, icon: '' },
        { name: 'Solana', ticker: 'SOL', amount: 0.02, fiat: 5.74, icon: '' }
      ],
      stats: [
        { label: 'Total Inflow', value: 2500.00 },
        { label: 'Total Outflow', value: 1049.50 },
        { label: 'Monthly Limit', value: 5000.00 }
      ],

        stats2: [
{ label: 'Date', value: "08/24"},
{ label: 'Balance', value: "17.24 dollars"},
{ label: 'Brand', value: "VISA" },
{ label: 'Owner', value: "xlavelia laga" },
{ label: 'Card Number', value: "7901 7728 8928 4581"}
      ]
    }
  ];
